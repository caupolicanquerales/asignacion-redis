...
public class PublishingGetPointOfSaleConfig {
	...
	private final EventInUse<GetPointsOfSaleEvent> eventPublisher;
	...
	@Autowired
	public PublishingGetPointOfSaleConfig(EventInUse<GetPointsOfSaleEvent> eventPublisher) {
		this.eventPublisher=eventPublisher;
	}
	
	@Bean
    public Supplier<Flux<Message<GetPointsOfSaleEvent>>> publishingGetPointOfSaleEvent() {
        return () -> this.eventPublisher.publish()
                                        .map(this::toMessage);
    }
	
	private Message<GetPointsOfSaleEvent> toMessage(GetPointsOfSaleEvent event) {
